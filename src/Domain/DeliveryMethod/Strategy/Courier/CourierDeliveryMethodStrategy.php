...
namespace App\Domain\DeliveryMethod\Strategy\Courier;
...
class CourierDeliveryMethodStrategy implements DeliveryMethodStrategyInterface
{
    ...
    {
        return DeliveryMethodEnum::COURIER === DeliveryMethodEnum::from($deliveryMethodCode);
    }
}
