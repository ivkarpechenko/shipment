...
class UpdateCityCommandTest extends MessageBusTestCase
{
    public function testCommandInstanceOf()
    {
        $this->assertInstanceOf(
            Command::class,
            new UpdateCityCommand(Uuid::v1(), 'city', 'Moskva', true)
        );
        $this->assertInstanceOf(
    ...
    {
        $command = new UpdateCityCommand(Uuid::v1(), 'city', 'Moskva', true);
    ...
    public function testUpdateCityCommandHandler()
    {
        ...
        $container->get(UpdateCityCommandHandler::class)(
            new UpdateCityCommand($newCity->getId(), 'village', 'Moskva2', true)
        );

        $city = $container->get(CityRepositoryInterface::class)->ofTypeAndName('village', 'Moskva2');
